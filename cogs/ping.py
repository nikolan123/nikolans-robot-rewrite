...
class pingcmd(commands.Cog):
    ...
    async def credyts(self, ctx):
        ...
        async def first_page(interaction):
            ...
            camputers_button = Button(label="Camputers", style=discord.ButtonStyle.blurple)
