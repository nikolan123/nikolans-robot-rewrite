...
class animalz(commands.Cog):
    ...
    @commands.slash_command(integration_types={discord.IntegrationType.guild_install,discord.IntegrationType.user_install}, name="doggo", description="Sends a random dog picture.")
    ...
    @commands.slash_command(integration_types={discord.IntegrationType.guild_install,discord.IntegrationType.user_install}, name="dogfact", description="Sends a random dog fact.")
    @commands.cooldown(1, 3, BucketType.user)
    ...
    @commands.slash_command(integration_types={discord.IntegrationType.guild_install,discord.IntegrationType.user_install}, name="sandcar", description="Sends a sand car. :3 :3 :3 :3")
